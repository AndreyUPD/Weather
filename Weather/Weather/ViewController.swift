...
//  Weather
//
//  Created by Андрей Михайлиди on 06.02.2022.
//
...
class ViewController: UIViewController {
    ...
    func updateWeatherInfo(latitude: Double, longitude: Double) {
        ...
        let url = URL(string: "http://api.openweathermap.org/data/2.5/weather?lat=\(latitude.description)&lon=\(longitude.description)&units=metric&lang=ru&APPID=a12738cd08efb0d0e9507230f457d920")!
